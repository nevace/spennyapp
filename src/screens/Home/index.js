...
import { Image, View, TouchableOpacity, TouchableNativeFeedback } from "react-native";
import {
  Container,
  Header,
  Content,
                ...
                >
                  <View style={styles.cardView}>
                    ...
                    <View style={{ marginLeft: 10 }}>
                      ...
                      <View style={styles.rowView}>
                        <View>
                          {/*<Text style={styles.offerText}>{userDataRow.price}</Text>*/}
                        </View>
                        <View>
                          {/*<Text style={styles.offerText}>{userDataRow.offer2}</Text>*/}
                        </View>
                      </View>
                    </View>
                  </View>
