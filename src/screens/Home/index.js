			...
			data && (
				<Container>
					<Header style={styles.head}>
						...
						<Right>
							<Button transparent onPress={() => navigation.navigate('Favourites')} style={{ paddingLeft: 10 }}>
								<Icon name="ios-heart" />
							</Button>
						</Right>
					</Header>
						...
						<View style={styles.subHeaderContentView}>
							<View style={styles.subHeaderInnerContentView}>
								<Item borderType="regular" style={styles.restaurantSearchInput}>
									<Icon active name="search" style={{ color: commonColor.brandPrimary, paddingLeft: 7 }} />
									<Input
										style={{
							...
							renderRow={partner => (
								...
								>
									<View style={styles.cardView}>
										<View style={{ width: 80 }}>
											<Image source={{ uri: partner.profile_image }} style={styles.restaurantFoodImg} />
										...
										<View style={{ marginLeft: 10 }}>
											<View style={styles.rowView}>
												<Text style={styles.hotelNameText}>{partner.name}</Text>
												{/*<Text style={styles.timeText}>{userDataRow.timing}</Text>*/}
											</View>
											<View style={styles.rowView}>
												<View style={{ paddingTop: 5 }}>
													<Text style={styles.offerText}>{partner.cuisine.join(', ')}</Text>
												</View>
												<View style={{ paddingTop: 5 }}>
													{/*<Text style={styles.offerText}>{userDataRow.offer1}</Text>*/}
												</View>
											</View>
											<View style={styles.rowView}>
												<View>{/*<Text style={styles.offerText}>{userDataRow.price}</Text>*/}</View>
												<View>{/*<Text style={styles.offerText}>{userDataRow.offer2}</Text>*/}</View>
											</View>
										</View>
									</View>
								</ListItem>
